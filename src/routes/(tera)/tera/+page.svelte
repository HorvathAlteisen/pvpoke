...
<Scripts>
	<script src="{webRoot}tera/js/GameMaster.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/Trait.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/Pokemon.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/TeraRanker.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/TeraInterface.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/ModalWindow.js?v={siteVersion}"></script>
	<script src="{webRoot}tera/js/Main.js?v={siteVersion}"></script>
</Scripts>
