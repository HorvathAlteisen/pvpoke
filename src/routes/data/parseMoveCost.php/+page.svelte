<script lang="ts">
	/**
	 * data/parseMoveCost.php — manual developer tool, ported verbatim (bare page, no site chrome).
	 * Refreshes buddy distance and third-move cost from the app game master; the result is
