<script lang="ts">
	/**
	 * data/parseEvolution.php — manual developer tool, ported verbatim (bare page, no site chrome).
	 * Rebuilds the `family` blocks of gamemaster/pokemon.json from the app game master; the
	 * result is printed to the browser console.
	 */
