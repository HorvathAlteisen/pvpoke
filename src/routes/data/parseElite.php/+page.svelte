<script lang="ts">
	/**
	 * data/parseElite.php — manual developer tool, ported verbatim (bare page, no site chrome).
	 * Merges the app game master's elite move lists into gamemaster.json; the result is printed
