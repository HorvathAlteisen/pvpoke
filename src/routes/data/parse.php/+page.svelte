<script lang="ts">
	/**
	 * data/parse.php — manual developer tool, ported verbatim (bare page, no site chrome).
	 * Adapts the Niantic app game master (data/gamemaster/gamemaster-app.json, not in the repo)
	 * into the site's Pokemon entries; the result is printed to the browser console.
	 */
