<script lang="ts">
	...
	/** PHP: `<?php if($_SETTINGS->xls): echo "on"; endif; ?>` — plain truthiness, not `== 1`. */
	const xlsOn = $derived(phpTruthy(settings.xls) ? 'on' : '');
</script>
	...
	<div class="toggle-content team-advanced">
		...
		<div class="flex poke">
			...
			<div class="team-option">
				...
				<div class="check allow-xl {xlsOn}"><span></span>Show Pokemon above level 40 in threats and alternatives</div>
			</div>
			<div class="team-option">
...
<script src="{webRoot}js/interface/TeamInterface.js?v={siteVersion}"></script>
...
<script src="{webRoot}js/Main.js?v=3"></script>
</Scripts>
