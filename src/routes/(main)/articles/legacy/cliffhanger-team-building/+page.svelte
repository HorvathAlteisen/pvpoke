<script lang="ts">
	/** articles/legacy/cliffhanger-team-building.php */
...
<div class="section article white">
	...
	<div class="date">Last updated June 10, 2020</div>
	...
	<p>Also be sure to check out the full rules in the updated <a href="https://reddit.com/r/TheSilphArena/comments/h00kkt/cliffhanger_31_tier_update/" target="_blank">announcement post</a>!</p>
<p>Jump to a section:
  <ol>
				<li><a href="#rules">Cliffhanger Rules &amp; Team Archetypes</a></li>
				<li><a href="#slots">Team-Building with Slots</a></li>
				<li><a href="#testing">Testing Your Team</a></li>
	  </ol>
	<a name="rules"></a>
<h3 class="article-header"><strong>Cliffhanger Rules &amp; Team Archetypes</strong></h3>
	<p><img src="{webRoot}articles/article-assets/cliffhanger-team-building/cliffhanger-rules-3-1.jpg" /></p>
...
<ul type="disc">
  ...
  <li>9 1 1 1 1 1</li>
  <li>5 5 1 1 1 1</li>
  <li>0 0 0 0 0 0 (if you&rsquo;re crazy)</li>
</ul>
...
<p>The infographic below highlights a few of the  possible picks in different slots and the roles they play for your team: </p>
	<p><img src="{webRoot}articles/article-assets/cliffhanger-team-building/cliffhanger-infographic-3-1.jpg?v=2" /></p>
...
<ol start="1" type="1">
  ...
  <li><strong>Perrserker (1 point) </strong>with       Foul Play and Iron Head counters Flying types, resists Psychic attacks,       and hits Fairy types hard. It loses to Fighting and Ground attacks.<strong></strong></li>
  ...
  <li><strong>Rainy Castform (0 points)</strong> with Weather Ball and Thunder provides additional Fire coverage and supports the team with decent bulk. It&rsquo;s most vulnerable to Grass and Electric types.<strong></strong></li>
  <li><strong>Alolan Muk (1 point) </strong>rounds out the team as a hard counter to Psychic types and a resistance Grass-type attacks.</li>
</ol>
<p>This gives you a fairly well-rounded team, but  even the example above has some gaps. Opposting Altaria could pose pose a problem. Team building is a game of give and take. See which  picks work for you and experiment with different ways to build out your  coverage! </p>
<p>Be sure to take advantage of the <a href="{webRoot}team-builder/">Team Builder</a> tool, which can help you identify coverage problems for your team and find alternatives.</p>
<a name="testing"></a>
  <h3 class="article-header"><strong>Testing Your Team</strong></h3>
    ...
    <ul type="disc">
      <li>Which Pokemon do opponents tend to pick against my       team?</li>
      <li>Which Pokemon do I lack an answer for?</li>
      <li>Which team compositions are giving me the most trouble?</li>
      <li>Which team compositions are working best for me?</li>
      <li>If I could add one Pokemon to my team, which would help       me the most?</li>
    </ul>
    <p>Your team might go through several iterations as  you figure out which Pokemon work best for you. Don&rsquo;t be afraid to change it up  and try new things! </p>
