<script lang="ts">
	 ...
	 *
	 * The bottom-of-page rating-table script used PHP to interpolate $WEB_ROOT into a JS
	 * string; it's rewritten to use the JS global `webRoot` instead, per the porting
	 * convention for inline scripts that needed PHP interpolation. The rest is unchanged.
	 */
...
<div class="section article white">
	...
	<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/banner.jpg" style="border:none;" /></p>
	...
	<p>Jump to a section:
		...
		<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/mechanics-duration-timeline.png" style="border:none;" /></p>
		...
		<div class="article-section">
			...
			<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/mechanics-register-2-2-new.png" style="border:none;" /></p>
			...
			<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/mechanics-register-2-4-new.png" style="border:none;" /></p>
			...
			<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/mechanics-register-1-3.png" style="border:none;" /></p>
			...
			<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/mechanics-register-2-3-new.png" style="border:none;" /></p>
		...
		<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/interruption-example.png" style="border:none;" /></p>
		...
		<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/optimized-timing.png" style="border:none;" /></p>
		...
		<p><img src="{webRoot}articles/article-assets/guide-to-fast-move-registration/optimal-timing-guide.png" style="margin: 0 auto;" /></p>
