<script lang="ts">
	 ...
	 * string (`"<?php echo $WEB_ROOT; ?>battle/1500/"+id+...`); it's rewritten to use the JS
	 * global `webRoot` instead, per the porting convention for inline scripts that needed PHP
	 * interpolation. The rest of the script is unchanged.
	 */
...
<div class="section article white">
	...
	<p>Jump to a section:
		...
		<img src="{webRoot}articles/article-assets/developer-notes-1-27-0/sim-update-rankings.jpg" />
