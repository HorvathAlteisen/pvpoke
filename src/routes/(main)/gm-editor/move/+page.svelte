...
<div class="section white" id="gm-editor-moves">
    <div class="flex space-between align-items-start">
        <a class="gm-title" href="{webRoot}gm-editor/moves/">&larr; All Moves</a>
        <div class="ranking-categories mode-select">
            <a href="{webRoot}gm-editor/pokemon/">Pokemon</a>
            <a class="selected" href="{webRoot}gm-editor/moves/">Moves</a>
        </div>
    </div>
...
<script src="{webRoot}js/devtools/gm-editor/GMEditorMoveInterface.js?v={siteVersion}"></script>
