...
<div  id="gm-editor" class="section white custom-rankings-import">
    ...
    <div class="gm-editor-block">
        ...
        <div class="flex gap-15">
            <a id="save-new-btn" href="{webRoot}gm-editor/pokemon/" class="button">Save New</a>
            <a id="save-btn" href="#" class="button" style="display: none" disabled>Save Changes</a>
            <a id="edit-btn" href="{webRoot}gm-editor/pokemon/" class="button" style="display: none">Edit</a>
        </div>
    </div>
...
<script src="{webRoot}js/devtools/gm-editor/GMEditorInterface.js?v={siteVersion}"></script>
