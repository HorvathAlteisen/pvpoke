<script lang="ts">
	...
	import LeagueSelect from '$lib/components/modules/LeagueSelect.svelte';
...
<div class="section league-select-container white">
	...
	<p class="description matrix hide">Battle two groups of Pokemon against each other and see a matrix of the results. Use this to explore mass matchups or compare different Pokemon, movesets, or IV's. You can change how the matrix results display on the <a href="{webRoot}settings/">Settings page</a>.</p>
</div>
...
<div class="section battle">
	...
	<div class="battle-results single">
		...
		<div class="tip automated">Hover over or tap the timeline for details. <a href="{webRoot}articles/strategy/guide-to-fast-move-registration/">Read more</a> about the timeline.</div>
	...
	<div class="section white battle-results matrix article">
		...
		<div class="toggle-content">
			...
			<p class="attack">Explore Attack stat differential against this group of Pokemon to analyze <a href="{webRoot}attack-cmp-chart/all/1500/" target="_blank">Charged Move Priority</a>. Select a column to sort.</p>
...
<script src="{webRoot}js/interface/Interface.js?v={siteVersion}"></script>
...
<script src="{webRoot}js/interface/BattleHistogram.js?v={siteVersion}"></script>
