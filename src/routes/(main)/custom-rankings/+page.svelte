<script lang="ts">
	...
	import CupSelect from '$lib/components/modules/CupSelect.svelte';
...
<div class="section white custom-rankings-meta-group">
	<h3>Custom Group</h3>
	<p>Save or copy this custom group of the top 100 Pokemon to use in <a href="{webRoot}battle/" target="_blank">Multi-Battle</a> or the <a href="{webRoot}team-builder/" target="_blank">Team Builder</a>.</p>
...
<script src="{webRoot}js/battle/rankers/Ranker.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/PokeSearch.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/Pokebox.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/RankingInterface.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/PokeSelect.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/PokeMultiSelect.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/CustomRankingInterface.js?v={siteVersion}"></script>
<script src="{webRoot}js/interface/ModalWindow.js?v={siteVersion}"></script>
<script src="{webRoot}js/RankerMain.js"></script>
</Scripts>
