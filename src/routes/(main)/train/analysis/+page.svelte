<script lang="ts">
	...
	// A <div> inside a <p>: Svelte rejects that nesting (node_invalid_placement), so the
	// paragraph is emitted raw to keep the markup byte-identical to the PHP.
	const usageModalIntro =
...
<div class="section analysis-container white">
	...
	<div class="ranking-categories mode-select">
		<a href="{webRoot}train/">Train</a>
		<a class="selected" href="{webRoot}train/analysis/">Top Performers</a>
	</div>
...
<script src="{webRoot}js/interface/TrainRankingInterface.js?v={siteVersion}"></script>
