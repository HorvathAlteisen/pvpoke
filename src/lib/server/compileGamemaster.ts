...
export function compileGamemaster(): CompileResult {
	...
	// Localized species names, keyed by speciesId; generated by scripts/generate-pokemon-names.ts.
	const pokemonNames = readJson(join(dir, 'gamemaster', 'pokemonNames.json'));

	base['timestamp'] = phpDateTime();
	base['pokemon'] = pokemon;
	base['moves'] = moves;
	base['formats'] = formats;
	base['pokemonNames'] = pokemonNames;
