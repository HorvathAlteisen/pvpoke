<script lang="ts">
	/**
	 * modules/articlepreview.php — the hidden `.article-item.template` row plus the global
	 * `makeArticleItem()` that ArticlesInterface.js calls to build each article card.
	 */
