<script lang="ts">
	/** modules/search-string-help-moves.php — hidden help table for the move search syntax. No PHP. */
</script>

<div class="sandbox-search-strings article hide">
	<p>You can use the following search formats to filter moves:</p>
	<table cellspacing="0">
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>general, spam/bait, nuke, etc.</td>
			</tr>
			<tr>
