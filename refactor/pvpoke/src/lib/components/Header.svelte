<script>
	...
	if (!metaTitle.includes('PvPoke')) {
		metaTitle += ' | PvPoke';
	}

	let metaDescription = META_DESCRIPTION || 'Looking for an edge in Pokemon GO Trainer Battles? Become a master with our open-source Pokemon battle simulator, explore the top Pokemon rankings, and get your team rated for PvP battles.';
	let ogImage = OG_IMAGE || 'https://pvpoke.com/img/og.jpg';
...
<svelte:head>
	...
	{#if SETTINGS.theme && SETTINGS.theme !== "default"}
		<link rel="stylesheet" type="text/css" href={WEB_ROOT + "css/themes/" + SETTINGS.theme + ".css?v=27"}>
	{/if}
	...
	<header>
		<div class="header-wrap">
			{#if SETTINGS.theme === 'night'}
				<a href={WEB_ROOT}><img src={WEB_ROOT + "img/themes/sunflower/header-white.png"} title="PvPoke.com" /></a>
			{:else}
				<a href={WEB_ROOT}><img src={WEB_ROOT + "img/themes/sunflower/header.png"} title="PvPoke.com" /></a>
			{/if}
